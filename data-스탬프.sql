...
--업체스탬프
insert into stmp_bnf(msno, sb_cnt, sb_cont) values(5, 15,'마사지');
insert into stmp_bnf(msno, sb_cnt, sb_cont) values(5, 10,'네일아트');
insert into stmp_bnf(msno, sb_cnt, sb_cont) values(6, 15,'피부관리');
insert into stmp_bnf(msno, sb_cnt, sb_cont) values(6, 15,'전신마사지');
insert into stmp_bnf(msno, sb_cnt, sb_cont) values(7, 5,'네일아트');
insert into stmp_bnf(msno, sb_cnt, sb_cont) values(7, 10,'마사지');
