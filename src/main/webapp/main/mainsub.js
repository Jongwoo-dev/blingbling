...
$.getJSON('../corporate/searchBybaseAdress.json?bas_adr='+basclk, function(ajaxResult) {
...
$.getJSON('../corporate/searchBybaseAdress.json?bas_adr='+detclk, function(ajaxResult) {
	var status = ajaxResult.status;
